...
payload = {'since':'2014-01-01T00:00:00Z','until':'2015-01-01T00:00:00Z','access_token':tk}
...
r = requests.get("https://api.github.com/repos/cyendra/CyDES/commits", params = payload)
